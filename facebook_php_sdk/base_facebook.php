 ...
 */
class FacebookApiExceptionPost extends Exception
{
  /**
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class BaseFacebookPost
{
  /**
   * Version.
   */
  ...
  public function setExtendedAccessToken() {
    ...
    catch (FacebookApiExceptionPost $e) {
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new FacebookApiExceptionPost(array(
  ...
  protected function throwAPIException($result) {
    $e = new FacebookApiExceptionPost($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
