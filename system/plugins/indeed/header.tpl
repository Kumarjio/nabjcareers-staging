...
<div class="" style="text-align:center; padding:10px 0 0 0; margin:0">[[You are Visiting an {$GLOBALS.settings.site_title} Partner Site]] <input type="button" name="return" value="[[Retutn:row]]"onclick="history.back()"></div>