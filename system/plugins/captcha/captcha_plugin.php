...
class CaptchaPlugin extends SJB_PluginAbstract 
{
	function pluginSettings ()
	{
		...
		$lineNoise = SJB_Settings::getSettingByName('custLineNoiseLeve')?SJB_Settings::getSettingByName('custLineNoiseLeve'):5;
		...
		switch ($captchaType) {
			...
			case 'customCaptcha':
				...
				$settings = array(
					...
					array (
						'id'			=> 'custLineNoiseLeve',
						'caption'		=> 'Line Noise Leve',
						'type'			=> 'integer',
						'length'		=> '50',
						'order'			=> null,
					)
