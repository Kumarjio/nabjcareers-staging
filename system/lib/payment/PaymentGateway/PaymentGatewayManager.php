...
require_once 'payment/PaymentGateways/AuthNetSIM.php';

require_once 'payment/PaymentGateways/AuthNetARB.php';

require_once 'payment/PaymentGateways/TwoCheckOut.php';

require_once 'payment/PaymentGateways/TwoCheckOutPNP.php';

require_once 'payment/PaymentGateways/PayPal.php';

require_once 'payment/PaymentGateways/CashPayment.php';

require_once 'payment/PaymentGateways/AuthNetAIM.php';
...

{
    ...
    function createObjectByID($gateway_id, $gateway_info = null)

	{
		...
		switch ($gateway_id) {
			...
			case 'authnet_aim':
				...
				$gateway = new SJB_AuthNetAIM($gateway_info);
            ...
            case '2checkout_recurring':
                ...
                $gateway = new SJB_TwoCheckOutPNP($gateway_info);
				...
				break;
								...
								case 'quantumgateway':
									...
									$gateway = new SJB_QuantumGateway($gateway_info);
    ...
    function getObjectByID($gateway_id, $recurring = false)
    ...
    function deleteGateway($gateway_sid)
	...
	function getInfoBySID($gateway_sid)
    ...
    function getSIDByID($gateway_id)

    {

    	$gateway_info = SJB_DB::query('SELECT `sid` FROM `payment_gateways` WHERE `id`=?s', $gateway_id);

    	if (!empty($gateway_info))

    		return array_pop(array_pop($gateway_info));
    ...
    function getActivePaymentGatewaysList()
    ...
    function activateByID($gateway_id)
    ...
    function deactivateByID($gateway_id)
