...
class SJB_CurrencyManager extends SJB_Object
{
    ...
    function getCurrencyList($currencyId = false)
    {
    	if ($currencyId)
...
class SJB_CurrencyDBManager extends SJB_ObjectDBManager
{
	...
	function getCurrencyInfoBySID($currency_sid)
	{
    	return parent::getObjectInfo("currency", $currency_sid);
	}
	
	function deleteCurrencyBySID($currency_sid)
	{
		return parent::deleteObjectInfoFromDB('currency', $currency_sid);
	}
	
	function makeDefaultCurrencyBySID($currency_sid)
	{
	...
	function updateStatusCurrencyBySID($currency_sid, $status)
	{
