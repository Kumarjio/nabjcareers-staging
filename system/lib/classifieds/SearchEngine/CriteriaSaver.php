...
class SJB_CriteriaSaver {
	...
	{
		$_SESSION[$this->storage_id]['found_sids'] = base64_encode(gzcompress(implode(',',$object_sids)));
	...
	function getObjectSIDs()
	{
		if (isset($_SESSION[$this->storage_id]['found_sids'])) {
			$this->object_sids = explode(',',gzuncompress(base64_decode($_SESSION[$this->storage_id]['found_sids'])));
		}
