...
require_once('classifieds/MetaString.php');
require_once('classifieds/MetaFloat.php');
require_once('classifieds/MetaInteger.php');
require_once('classifieds/MetaText.php');
require_once('classifieds/MetaBoolean.php');
require_once('classifieds/MetaList.php');

class SJB_Types
{
	function display($object_info, $display_type)
	{
