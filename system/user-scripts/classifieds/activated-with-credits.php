...
/* 14 feb 2016 job credits mod */
$m = 0;
$alreadyCreditedJobs = array();
foreach ($_GET as $alreadyCreditedJobId) {
	$m++;
	$alreadyCreditedJobs[$m] = $alreadyCreditedJobId;	
}

if ($alreadyCreditedJobs)
{
	$tp->assign("activated_jobs", $alreadyCreditedJobs);
}
/* END 14 feb 2016 job credits mod */
...
$tp->display('activated_my_listings.tpl');
