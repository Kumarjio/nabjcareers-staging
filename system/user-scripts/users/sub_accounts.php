...
switch (SJB_Request::getVar('action_name')) {
	case 'new':
		...
		if ($form_submitted && $registration_form->isDataValid($errors)) {
			...
			$subuserPermissions = array('subuser_add_listings', 'subuser_manage_listings', 'subuser_manage_subscription');
			...
			SJB_Notifications::sendSubuserRegistrationLetter($user, SJB_Request::get());
