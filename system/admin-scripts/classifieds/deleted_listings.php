...
$template_processor->display("deleted_listings.tpl"); 
...
/** Deleted Jobs MOD 09-06-2014 */
if (SJB_Request::getVar('restore', '') == 'restore_job' ) {
	// RESTORE this job 
	$restore_listing_id = isset($_REQUEST['restore_listing_id']) ? $_REQUEST['restore_listing_id'] : 0;
	
	SJB_ListingManager::restoreDeletedListingBySID($restore_listing_id);
	//SJB_ListingManager::activateListingBySID($restore_listing_id);
}
/** END of Deleted Jobs MOD 09-06-2014 */
...
$template_processor->display("deleted_jobs_display_results.tpl");
