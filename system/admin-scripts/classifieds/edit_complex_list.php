...
require_once("classifieds/ListingField/ListingComplexEditListController.php");
require_once("classifieds/ListingField/ListingComplexDisplayListController.php");

$edit_list_controller = new SJB_ListingComplexEditListController($_REQUEST);
$template_processor = SJB_System::getTemplateProcessor();
$field_sid = SJB_Request::getVar('field_sid', false);
