<?php  /* Smarty version 2.6.14, created on 2014-10-22 01:10:21
...
unset($_smarty_tpl_vars);
 ?>
	<?php  if ($this->_tpl_vars['form_is_submitted'] && ! $this->_tpl_vars['errors'] && ! $this->_tpl_vars['field_errors']): ?>
		...
		<?php  echo '
		<script language="JavaScript">location.href=\'';   echo $this->_tpl_vars['GLOBALS']['site_url']; ?>
/manage-listing/?listing_id=<?php  echo $this->_tpl_vars['listing']['id'];   if ($this->_tpl_vars['GLOBALS']['user_page_uri'] == "/edit-listing/" && $this->_tpl_vars['listing']['type']['id'] == 'Job'): ?>&edit_job=edit_job<?php  endif;   echo '\';</script>
		'; ?>
