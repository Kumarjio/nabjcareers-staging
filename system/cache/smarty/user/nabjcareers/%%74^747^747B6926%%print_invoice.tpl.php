<?php  /* Smarty version 2.6.14, created on 2014-10-20 16:14:15
         compiled from ../email_templates/print_invoice.tpl */ ?>
<?php  require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'subject', '../email_templates/print_invoice.tpl', 1, false),array('block', 'message', '../email_templates/print_invoice.tpl', 2, false),array('block', 'tr', '../email_templates/print_invoice.tpl', 26, false),array('modifier', 'date_format', '../email_templates/print_invoice.tpl', 30, false),)), $this); ?>
<?php  $this->_tag_stack[] = array('subject', array()); $_block_repeat=true;$this->_plugins['block']['subject'][0][0]->parseLetterSubject($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Invoice #<?php  echo $this->_tpl_vars['payment_info']['sid']; ?>
  from Asiamediajobs.com<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['subject'][0][0]->parseLetterSubject($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack);   $this->_tag_stack[] = array('message', array()); $_block_repeat=true;$this->_plugins['block']['message'][0][0]->parseLetterMessage($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
