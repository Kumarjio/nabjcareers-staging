<?php  /* Smarty version 2.6.14, created on 2018-03-28 10:09:59
         compiled from activated_my_listings.tpl */ ?>
<?php  require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', 'activated_my_listings.tpl', 7, false),array('modifier', 'cat', 'activated_my_listings.tpl', 10, false),array('modifier', 'count', 'activated_my_listings.tpl', 11, false),array('modifier', 'regex_replace', 'activated_my_listings.tpl', 172, false),array('modifier', 'default', 'activated_my_listings.tpl', 184, false),array('function', 'image', 'activated_my_listings.tpl', 57, false),array('function', 'cycle', 'activated_my_listings.tpl', 166, false),)), $this); ?>
<?php  $_from = $this->_tpl_vars['activated_jobs']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['activated_jobs_block'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['activated_jobs_block']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['activated_job']):
        $this->_foreach['activated_jobs_block']['iteration']++;
?>
<p class="message">Your Job ID <?php  echo $this->_tpl_vars['activated_job']; ?>
 has successfully been activated using your job credits.</p>
...
"><?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>here<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a> <?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>to add a new listing.<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></p>
	<?php  else: ?>
		...
		<?php  if ($this->_tpl_vars['listingsInfo']['listingsLeft'] != 0): ?>
			...
			<p><?php  if (! count($this->_tpl_vars['listings']) && empty ( $this->_tpl_vars['search_criteria'] ) && $this->_tpl_vars['GLOBALS']['current_user']['group']['id'] == 'Employer'):   $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>You have no listings now.<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack);   endif; ?> <?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Click<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> <a href="<?php  echo $this->_tpl_vars['url']; ?>
"><?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>here<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a> <?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>to add a new resume.<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></p>
		<?php  endif; ?>
	<?php  endif; ?>
...
<?php  if ($this->_tpl_vars['GLOBALS']['current_user']['group']['id'] == 'Employer'): ?>	
	<input id="confirm_activat_btn" type="submit" name="action_activate" value="<?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Confirm Activation and Pay<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" 
	class="button" onclick="return jobs_Status_Checker();" />
<?php  elseif ($this->_tpl_vars['GLOBALS']['current_user']['group']['id'] == 'JobSeeker'): ?>
	<input id="confirm_activat_btn" type="submit" name="action_activate" value="<?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Active Resume<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" class="button" />
<?php  endif; ?>	
	...
	<?php  if ($this->_tpl_vars['GLOBALS']['current_user']['group']['caption'] == 'Employer'): ?>
		<input type="submit" name="action_deleted" value="<?php  $this->_tag_stack[] = array('tr', array('mode' => 'raw')); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Delete Job<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" class="button" onclick="return confirm('<?php  $this->_tag_stack[] = array('tr', array('mode' => 'raw')); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Are you sure?<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>')" />
	<?php  else: ?>
...
"<?php  endif; ?>>
				<td> </td>
				<td class="noTdPad">
					<input type="checkbox" class="listings_checkboxes <?php  if ($this->_tpl_vars['listing']['active']): ?>activeListing<?php  endif; ?>" name="listings[<?php  echo $this->_tpl_vars['listing']['id']; ?>
]" value="1" 
						id="checkbox_<?php  echo $this->_foreach['listings_block']['iteration']; ?>
" <?php  if ($this->_tpl_vars['listing']['is_new'] == 1): ?>checked="checked"<?php  endif; ?> />
				</td>
...
"><?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Confirm Activation<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a> |<?php  endif; ?>
							<?php  endif; ?>
						</li>
							...
							<?php  if ($this->_tpl_vars['GLOBALS']['current_user']['group']['caption'] == 'Employer'): ?>
								<li><a href="?action_deleted=1&amp;listings[<?php  echo $this->_tpl_vars['listing']['id']; ?>
						...
						<?php  if (! $this->_tpl_vars['listing']['featured'] && $this->_tpl_vars['listing']['active']): ?>
							<li> | <a href="<?php  echo $this->_tpl_vars['GLOBALS']['site_url']; ?>
...
"><?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Upgrade to Featured<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a></li>
						...
						<?php  if (! $this->_tpl_vars['listing']['priority'] && $this->_tpl_vars['listing']['active']): ?>
							<li> | <a href="<?php  echo $this->_tpl_vars['GLOBALS']['site_url']; ?>
...
<?php  if ($this->_tpl_vars['GLOBALS']['current_user']['group']['id'] == 'Employer'): ?>	
	<input id="confirm_activat_btn" type="submit" name="action_activate" value="<?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Confirm Activation and Pay<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" class="button" onclick="return jobs_Status_Checker();"  />
<?php  elseif ($this->_tpl_vars['GLOBALS']['current_user']['group']['id'] == 'JobSeeker'):   endif; ?>	
