<?php  /* Smarty version 2.6.14, created on 2018-02-08 23:58:23
         compiled from ../payment/listing_activate_and_invoice.tpl */ ?>
<?php  require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'subject', '../payment/listing_activate_and_invoice.tpl', 1, false),array('block', 'message', '../payment/listing_activate_and_invoice.tpl', 2, false),array('block', 'tr', '../payment/listing_activate_and_invoice.tpl', 36, false),array('modifier', 'date_format', '../payment/listing_activate_and_invoice.tpl', 40, false),)), $this); ?>
<?php  $this->_tag_stack[] = array('subject', array()); $_block_repeat=true;$this->_plugins['block']['subject'][0][0]->parseLetterSubject($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Invoice #<?php  echo $this->_tpl_vars['payment_info']['sid']; ?>
  from Nabjcareers.org<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['subject'][0][0]->parseLetterSubject($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack);   $this->_tag_stack[] = array('message', array()); $_block_repeat=true;$this->_plugins['block']['message'][0][0]->parseLetterMessage($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<p>Dear <?php  echo $this->_tpl_vars['user_info']['ContactName']; ?>
,</p>
		
	<p>We have automatically activated your posting(s) <?php  $_from = $this->_tpl_vars['listings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
", <?php  endforeach; endif; unset($_from); ?>.</p>
	...
	To deactivate or delete it, go to <a href="<?php  echo $this->_tpl_vars['GLOBALS']['user_site_url']; ?>
/my-listings/">My Postings</a> section and use the "Deactivate" link opposite the #<?php  echo $this->_tpl_vars['listing']['id']; ?>
 posting.</p>
...
<br>
									<?php  echo $this->_tpl_vars['user_info']['billingCity']; ?>
 <?php  echo $this->_tpl_vars['user_info']['billingZip']; ?>
<br>
								</td>
								<td>
...
<br>
    ...
    foreach ($_from as $this->_tpl_vars['listing']):
?>
										<br><?php  echo $this->_tpl_vars['listing']['Title']; ?>
				...
				<tr>
					<td><?php  if ($this->_tpl_vars['send_email']): ?>Invoice successfully send<?php  endif; ?></td>
				</tr>
			</table>
		</td>
	</tr>
