<?php  /* Smarty version 2.6.14, created on 2018-02-08 14:53:40
         compiled from payment_page.tpl */ ?>
<?php  require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', 'payment_page.tpl', 31, false),array('function', 'math', 'payment_page.tpl', 37, false),array('function', 'module', 'payment_page.tpl', 201, false),array('modifier', 'count', 'payment_page.tpl', 189, false),array('modifier', 'count_words', 'payment_page.tpl', 223, false),array('modifier', 'regex_replace', 'payment_page.tpl', 223, false),)), $this); ?>
...
<?php  if (! $this->_tpl_vars['product_info']['featured_listing_id'] && ! $this->_tpl_vars['product_info']['priority_listing_id']): ?>
	<div id="larger_font">
		<?php  if ($this->_tpl_vars['product_info']['membership_plan_id'] != 33 && $this->_tpl_vars['product_info']['membership_plan_id'] != 37): ?> 			<table class="payment_table">
				<thead>
					<tr>
...
">delete</a>)</span><?php  else: ?>-<?php  endif; ?>
			...
			<p class="footnote_table">In order to exclude a job from the payment or cancel an add-on for the listing click the "delete" near the appropriate item.</p>
...
<?php  endforeach; else: ?>
	...
	<div class="payment_instructions_text">
