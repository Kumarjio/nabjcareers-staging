...
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', '../field_types/input/complex.tpl', 16, false),array('function', 'input', '../field_types/input/complex.tpl', 17, false),)), $this); ?>
<?php  $this->assign('complexField', $this->_tpl_vars['form_field']['id']); ?> <div id='complexFields_<?php  echo $this->_tpl_vars['complexField']; ?>
' class="<?php  if ($this->_tpl_vars['complexField'] == 'JobFairs'): ?>jobFairComplex<?php  else: ?>complex<?php  endif; ?> ">
...
' class="complex">
        ...
        <?php  if ($this->_tpl_vars['form_field']['id'] == 'JobFairs'): ?>
...
?>         	
					<?php  if ($this->_tpl_vars['form_field']['id'] == $this->_tpl_vars['jobfair']['fieldid']): ?>
			            <?php  if ($this->_tpl_vars['jobfair']['visible_js']): ?>
			                <fieldset>
