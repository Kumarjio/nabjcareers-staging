<?php  /* Smarty version 2.6.14, created on 2018-02-08 19:51:00
         compiled from my_account_job_seeker.tpl */ ?>
<?php  require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', 'my_account_job_seeker.tpl', 6, false),array('function', 'image', 'my_account_job_seeker.tpl', 11, false),array('function', 'module', 'my_account_job_seeker.tpl', 40, false),)), $this); ?>
<?php  if ($_GET['page']): ?>
<p class="message">Your resume has been activated.</p>
<?php  endif; ?>
...
/my-listings/"><?php  $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>My Resume<?php  $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a></li>
			<li><img src="<?php  echo $this->_plugins['function']['image'][0][0]->getImageURL(array(), $this);?>
