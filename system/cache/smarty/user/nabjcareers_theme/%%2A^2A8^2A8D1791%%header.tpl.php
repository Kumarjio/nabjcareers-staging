...
smarty_core_load_plugins(array('plugins' => array(array('function', 'image', '../menu/header.tpl', 1, false),array('function', 'module', '../menu/header.tpl', 450, false),array('block', 'tr', '../menu/header.tpl', 424, false),)), $this); ?>
<img src="<?php  echo $this->_plugins['function']['image'][0][0]->getImageURL(array(), $this);?>
icon-facebook.png" border="0" alt="News" title="News" style="position: absolute" width="1" height="1" />
<div class="MainDiv">
			...
			<tr>
				<td id="Toolbar_bg">
					<div id="Toolbar">
						...
						<?php  echo '<script type=\'text/javascript\'>function PrintPageClickHandler(){this.handleEvent = createPrintPagePopup }PrintPage_OnClick = new PrintPageClickHandler(); addEventHandler_OnLoad(function(){ var element = document.getElementById("PrintPage"); if(element) { element.onclick = PrintPage_OnClick.handleEvent; element.title = "Print Page";} });</script>'; ?>
...
/templates/nabjcareers_theme/nabj_org_elements/global_inc/RadControls/Menu/Scripts/4_3_2/RadMenu.js"></script>
						<span id="FrontendMainMenuStyleSheetHolder" style="display:none;"></span>
						
						
						<script type="text/javascript"><?php  echo 'RadControlsNamespace.AppendStyleSheet(false, \'FrontendMainMenu\', \'';   echo $this->_tpl_vars['GLOBALS']['site_url'];   echo '/templates/nabjcareers_theme/nabj_org_elements/global_inc/RadControls/Menu/Scripts/4_3_2/menu.css\');'; ?>
</script>	
					...
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td id="CenterColumn"><div id="SpMain">
								<style type="text/css">	<?php  echo '#tat_table {z-index:99;	}	#FavoriteEditorTitle {margin: 0;	}'; ?>
</style>
								...
								<style type="text/css"><?php  echo ' .ScoreControl {display:block;	float:left; } '; ?>
 </style>
								<table id="SpSubHead" border="0" cellpadding="0" cellspacing="0"><tr>
									<td id="SpTitleBar"><a href="<?php  echo $this->_tpl_vars['GLOBALS']['site_url']; ?>
/">NABJ Career Center</a>								
