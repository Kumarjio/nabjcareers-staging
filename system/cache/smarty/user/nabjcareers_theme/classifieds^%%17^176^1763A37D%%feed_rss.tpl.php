<?php  /* Smarty version 2.6.14, created on 2018-02-08 11:50:12
         compiled from feed_rss.tpl */ ?>
<?php  require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'regex_replace', 'feed_rss.tpl', 18, false),array('block', 'tr', 'feed_rss.tpl', 20, false),)), $this); ?>
<?php  echo '<?xml'; ?>
 version="1.0" encoding="utf-8" <?php  echo '?>'; ?>

<rss version="2.0">
  <channel>
    <title><![CDATA[<?php  echo $this->_tpl_vars['feed']['name']; ?>
]]></title>
...
?>
   	<item>
		<title><![CDATA[<?php  echo ((is_array($_tmp=$this->_tpl_vars['listing']['Title'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/[\\/\\\:*?\"<>|%&#$\s]/", "-") : smarty_modifier_regex_replace($_tmp, "/[\\/\\\:*?\"<>|%&#$\s]/", "-")); ?>
]]></title>
...
<br/>
 ...
 GMT</pubDate>
		<guid><![CDATA[<?php  echo $this->_tpl_vars['GLOBALS']['site_url']; ?>
/display-job/<?php  echo $this->_tpl_vars['listing']['id']; ?>
/<?php  echo ((is_array($_tmp=$this->_tpl_vars['listing']['Title'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/[\\/\\\:*?\"<>|%&#$\s]/", "-") : smarty_modifier_regex_replace($_tmp, "/[\\/\\\:*?\"<>|%&#$\s]/", "-")); ?>
.html]]></guid>
	</item>
