...
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', 'edit_profile.tpl', 1, false),array('function', 'module', 'edit_profile.tpl', 4, false),array('function', 'input', 'edit_profile.tpl', 51, false),)), $this); ?>
...
?>
			<?php  if ($this->_tpl_vars['show_mailing_flag'] == 0 && $this->_tpl_vars['form_field']['id'] == 'sendmail'): ?>
				...
				<?php  elseif ($this->_tpl_vars['form_field']['id'] == 'JobCredits'): ?>
				<br/>
				...
				<fieldset>
					...
					<div class="inputField"><?php  echo $this->_tpl_vars['GLOBALS']['current_user']['JobCredits']; ?>
</div>
				</fieldset>
					
					
					<?php  elseif ($this->_tpl_vars['form_field']['id'] == 'JobCredits30'): ?>
						<fieldset><div class="inputName"></div></fieldset>
						<fieldset><div class="inputName"><?php  $this->_tag_stack[] = array('tr', array('metadata' => $this->_tpl_vars['METADATA']['form_field']['caption'])); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start();   echo $this->_tpl_vars['form_field']['caption'];   $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div><div class="inputField"><?php  echo $this->_tpl_vars['GLOBALS']['current_user']['JobCredits30']; ?>
</div></fieldset>
					
					<?php  elseif ($this->_tpl_vars['form_field']['id'] == 'JobCredits60'): ?>
						<fieldset><div class="inputName"></div></fieldset>
						<fieldset><div class="inputName"><?php  $this->_tag_stack[] = array('tr', array('metadata' => $this->_tpl_vars['METADATA']['form_field']['caption'])); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start();   echo $this->_tpl_vars['form_field']['caption'];   $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div><div class="inputField"><?php  echo $this->_tpl_vars['GLOBALS']['current_user']['JobCredits60']; ?>
</div></fieldset>					

					<?php  elseif ($this->_tpl_vars['form_field']['id'] == 'JobCredits90'): ?>
						<fieldset><div class="inputName"></div></fieldset>
						<fieldset><div class="inputName"><?php  $this->_tag_stack[] = array('tr', array('metadata' => $this->_tpl_vars['METADATA']['form_field']['caption'])); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start();   echo $this->_tpl_vars['form_field']['caption'];   $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div><div class="inputField"><?php  echo $this->_tpl_vars['GLOBALS']['current_user']['JobCredits90']; ?>
</div></fieldset>
					<br/>
			
							<?php  elseif ($this->_tpl_vars['form_field']['id'] == 'resume_bonus_days'): ?>
						<fieldset><div class="inputName"><?php  $this->_tag_stack[] = array('tr', array('metadata' => $this->_tpl_vars['METADATA']['form_field']['caption'])); $_block_repeat=true;$this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start();   echo $this->_tpl_vars['form_field']['caption'];   $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['tr'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div><div class="inputField"><?php  echo $this->_tpl_vars['GLOBALS']['current_user']['resume_bonus_days']; ?>
</div></fieldset>
