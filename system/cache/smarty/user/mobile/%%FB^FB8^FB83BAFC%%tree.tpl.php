<?php  /* Smarty version 2.6.14, created on 2016-07-12 13:21:47
         compiled from ../field_types/search/tree.tpl */ ?>
<?php  require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', '../field_types/search/tree.tpl', 133, false),)), $this); ?>
<?php  echo '
<style type="text/css">
ul.tree, ul.tree * {
...
ul.tree li .arrow {
	...
	background-image: url(';   echo $this->_tpl_vars['GLOBALS']['site_url'];   echo '/system/ext/jquery/ltL_nes.gif);
}
...
[tree]' id='tree_<?php  echo $this->_tpl_vars['id']; ?>
_selected' value='' />
...
$.get("<?php  echo $this->_tpl_vars['GLOBALS']['user_site_url']; ?>
/get-tree/", { id: "<?php  echo $this->_tpl_vars['sid']; ?>
", name: "<?php  echo $this->_tpl_vars['id']; ?>
", check: tree_<?php  echo $this->_tpl_vars['id']; ?>
_select_string, search: "yes" },
		  function(data){
            ...
            $(this).children("li").each(function(li){
                ...
                $(this).children(":checkbox").attr("checked", act);
                    if ($(this).children("ul").size() > 0){
                        ...
                        setChildrenStatus_';   echo $this->_tpl_vars['id']; ?>
