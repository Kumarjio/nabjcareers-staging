...
<?php  echo smarty_function_WYSIWYGEditor(array('name' => $this->_smarty_vars['capture']['wysiwygName'],'class' => $this->_smarty_vars['capture']['wysiwygClass'],'width' => "100%",'height' => '150','type' => $this->_tpl_vars['wysiwygType'],'value' => $this->_tpl_vars['value'],'conf' => 'BasicAdmin'), $this);?>