...
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', '../field_types/search/list.tpl', 5, false),)), $this); ?>
<select name='<?php  echo $this->_tpl_vars['id']; ?>
[equal]'>
	<?php  if ($this->_tpl_vars['id'] != 'data_source'): ?>
		<option value="">Any <?php  echo $this->_tpl_vars['caption']; ?>
</option>
	<?php  elseif ($this->_tpl_vars['id'] == 'data_source'): ?>
...
' <?php  if ($this->_tpl_vars['list_value']['id'] == $this->_tpl_vars['value']['equal']): ?>selected="selected"<?php  endif; ?> ><?php  echo $this->_tpl_vars['list_value']['caption']; ?>
</option>
