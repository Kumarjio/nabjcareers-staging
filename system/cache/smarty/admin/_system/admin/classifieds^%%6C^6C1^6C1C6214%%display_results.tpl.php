<?php  /* Smarty version 2.6.14, created on 2018-02-08 14:47:23
         compiled from display_results.tpl */ ?>
<?php  require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', 'display_results.tpl', 37, false),array('function', 'image', 'display_results.tpl', 112, false),array('function', 'cycle', 'display_results.tpl', 215, false),array('modifier', 'regex_replace', 'display_results.tpl', 225, false),)), $this); ?>
...
<p>
	Results: <?php  echo $this->_tpl_vars['count_listings']; ?>
 listings
...
<table>
	<thead>
		<tr>
			...
			<th>
				<a href="?restore=1&amp;sorting_field=id&amp;sorting_order=<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC' && $this->_tpl_vars['listing_search']['sorting_field'] == 'id'): ?>DESC<?php  else: ?>ASC<?php  endif; ?>">ID</a>
				<?php  if ($this->_tpl_vars['listing_search']['sorting_field'] == 'id'): ?>
...
b_down_arrow.gif" alt="Down" />
			...
			<th>
				<a href="?restore=1&amp;sorting_field=Title&amp;sorting_order=<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC' && $this->_tpl_vars['listing_search']['sorting_field'] == 'Title'): ?>DESC<?php  else: ?>ASC<?php  endif; ?>">Title</a>
...
b_down_arrow.gif" alt="Down" />
			...
			<th>
				<a href="?restore=1&amp;sorting_field=listing_type&amp;sorting_order=<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC' && $this->_tpl_vars['listing_search']['sorting_field'] == 'listing_type'): ?>DESC<?php  else: ?>ASC<?php  endif; ?>">Listing Type</a>
				<?php  if ($this->_tpl_vars['listing_search']['sorting_field'] == 'listing_type'): ?>
					<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC'): ?>
						<img src="<?php  echo $this->_plugins['function']['image'][0][0]->getImageURL(array(), $this);?>
b_up_arrow.gif" alt="Up" />
					<?php  else: ?>
...
b_down_arrow.gif" alt="Down" />
			...
			<th>
				<a href="?restore=1&amp;sorting_field=JobCategory&amp;sorting_order=<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC' && $this->_tpl_vars['listing_search']['sorting_field'] == 'JobCategory'): ?>DESC<?php  else: ?>ASC<?php  endif; ?>">Job Category</a>
				<?php  if ($this->_tpl_vars['listing_search']['sorting_field'] == 'JobCategory'): ?>
					<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC'): ?>
						<img src="<?php  echo $this->_plugins['function']['image'][0][0]->getImageURL(array(), $this);?>
b_up_arrow.gif" alt="Up" />
					<?php  else: ?>
...
b_down_arrow.gif" alt="Down" />
			...
			<th>
				<a href="?restore=1&amp;sorting_field=activation_date&amp;sorting_order=<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC' && $this->_tpl_vars['listing_search']['sorting_field'] == 'activation_date'): ?>DESC<?php  else: ?>ASC<?php  endif; ?>">Activation Date</a>
...
b_down_arrow.gif" alt="Down" />
			...
			<th>
				<a href="?restore=1&amp;sorting_field=active&amp;sorting_order=<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC' && $this->_tpl_vars['listing_search']['sorting_field'] == 'active'): ?>DESC<?php  else: ?>ASC<?php  endif; ?>">Status</a>
				<?php  if ($this->_tpl_vars['listing_search']['sorting_field'] == 'active'): ?>
					<?php  if ($this->_tpl_vars['listing_search']['sorting_order'] == 'ASC'): ?>
						<img src="<?php  echo $this->_plugins['function']['image'][0][0]->getImageURL(array(), $this);?>
b_up_arrow.gif" alt="Up" />
					<?php  else: ?>
...
"><b><?php  echo $this->_tpl_vars['listing']['Title']; ?>
				...
				<td>
					<?php  $_from = $this->_tpl_vars['listing']['JobCategory']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['jobCategory'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['jobCategory']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['category']):
        $this->_foreach['jobCategory']['iteration']++;
?>
						<?php  echo $this->_tpl_vars['category'];   if (! ($this->_foreach['jobCategory']['iteration'] == $this->_foreach['jobCategory']['total'])): ?>, <?php  endif; ?>
...
"><?php  echo $this->_tpl_vars['listing']['user']['username']; ?>
				...
				<td><?php  if ($this->_tpl_vars['listing']['active'] == 1): ?>Active<?php  else: ?>Not Active<?php  endif; ?></td>
		        <?php  if ($this->_tpl_vars['showApprovalStatusField'] != false): ?>
...
/listing-actions/?action_name=Deactivate&amp;listings[<?php  echo $this->_tpl_vars['listing']['id']; ?>
]=1">Deactivate</a>
		            <?php  else: ?>
		                <a href="<?php  echo $this->_tpl_vars['GLOBALS']['site_url']; ?>
/listing-actions/?action_name=Activate&amp;listings[<?php  echo $this->_tpl_vars['listing']['id']; ?>
]=1">Activate</a>
		            <?php  endif; ?>
		        </td>
				<td><a href="<?php  echo $this->_tpl_vars['GLOBALS']['site_url']; ?>
...
]=1" onclick="return confirm('Are you sure you want to delete this listing?')" title="Delete"><img src="<?php  echo $this->_plugins['function']['image'][0][0]->getImageURL(array(), $this);?>
