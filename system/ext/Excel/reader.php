...
* @version    CVS: $Id: reader.php 770 2009-03-13 12:36:35Z nwy $
...
//                                              echo "Str $i = $retstr\n";
                ...
                case SPREADSHEET_EXCEL_READER_TYPE_CODEPAGE:
                  // echo "Type.CODEPAGE";
                       $codepage = $this->_GetInt2d($this->data, $pos+4);
...
//end of changes by mmp
    ...
    function _decodeCodepage($string){
        ...
        if ($this->_defaultEncoding && $this->_codepage){
        	switch ($this->_encoderFunction){
        		case 'iconv' : 	$result = iconv($this->_codepage, $this->_defaultEncoding, $string);
        						break;
        		case 'mb_convert_encoding' : 	$result = mb_convert_encoding($string, $this->_defaultEncoding, $this->_codepage );
        						break;
                }
        }
        return $result;
