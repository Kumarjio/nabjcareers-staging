...
(
	...
	(
		...
		(
			'display_name'	=> 'Send Newsletter',
			'script'		=> 'sendnewsletter.php',
			'type'			=> 'user',
			'access_type'	=> array('user'),
			'raw_output'	=> true,
		),
		'unsubscribe' => array
		(
			'display_name'	=> 'Unsubscribe Newsletter',
		...
		(
			...
			'type'			=> 'user',
			'access_type'	=> array('user'),
			'params'		=> array ('featured_profiles_template', 'number_of_rows', 'number_of_cols'),
		),
