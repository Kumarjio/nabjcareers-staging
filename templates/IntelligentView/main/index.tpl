...
<title>{if $GLOBALS.user_page_uri == "/news"}Asiamediajobs.com: News{elseif !$GLOBALS.page_not_found && !$exp_listings_404_page}{$GLOBALS.settings.site_title}{/if}{if $TITLE ne ""}{if !$GLOBALS.page_not_found && !$exp_listings_404_page}:{/if} [[$TITLE]]{/if}</title>
...
<div id="side_banners_container_index">{module name="banners" function="show_banners" group="Side Banners"}</div>	
