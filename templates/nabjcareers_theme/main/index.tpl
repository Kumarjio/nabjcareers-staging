...
{******** job credits display *********}				
			{if $GLOBALS.user_page_uri== "/payment-page/" || $GLOBALS.user_page_uri== "/my-listings/" || $GLOBALS.user_page_uri== "/manage-listing/" || $GLOBALS.user_page_uri== "/activated-with-credits/" || $GLOBALS.user_page_uri== "/add-listing/"}
				{if $GLOBALS.current_user.JobCredits30}<span> &nbsp; | &nbsp;[[30-day Job credits]]:<b> {$GLOBALS.current_user.JobCredits30} </b></span>&nbsp; | &nbsp;{/if}
				{if $GLOBALS.current_user.JobCredits60}<span> [[60-day Job credits]]:<b> {$GLOBALS.current_user.JobCredits60} </b></span>&nbsp; | &nbsp;{/if}
				{if $GLOBALS.current_user.JobCredits90}<span> [[90-day Job credits]]:<b> {$GLOBALS.current_user.JobCredits90} </b></span>&nbsp; | &nbsp;{/if}
			{/if}
{******** END of job credits display *********}
