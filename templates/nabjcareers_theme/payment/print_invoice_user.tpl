{if $GLOBALS.current_user.id  == $payment_info.user_sid}
<div style="padding: 5px;">
	<span class="buttonsinvoice"><a class="abuttonsinvoice" href="" onclick="window.print()">Print Invoice</a></span>
	
	{if $payment_info.callback_data == 'featured'}
		 <p style="display: none;"><iframe width="1" height="1" src="{$payment_info.success_page_url}"></iframe></p>
		{* <span class="buttonsinvoice_featured"><a id="confirm_featured_btn" class="abuttonsinvoice" href="{$payment_info.success_page_url}" target="_top">Upgrade to Featured</a></span> *}
	{elseif $payment_info.callback_data == 'priority'}
		<p style="display: none;"><iframe width="1" height="1" src="{$payment_info.success_page_url}"></iframe></p>
		{* <span class="buttonsinvoice_featured"><a id="confirm_featured_btn" class="abuttonsinvoice" href="{$payment_info.success_page_url}" target="_top">Upgrade to Priority</a></span> *}
	{/if}
...
<table width="99%" border="0" cellspacing="0" cellpadding="2" align="center" bgcolor="#999999" style="margin:8px; border:1px; width:99%">
	<tr>
		<td>
			...
			{*							<br>{if $listing.duration.0.number_of_days} Duration: {$listing.duration.0.number_of_days} days{/if} *}
