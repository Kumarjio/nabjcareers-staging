...
function ContentScoresClient(SessionID)
{
	...
	{	//fetch all scores waiting in queue
		...
		xmlhttp.open("http://www.nabj.org/POST", "http://www.nabj.org/global_engine/ContentScores_getScores.asp", false);
	...
	{	//set voting control state
		...
		{	//enable voting controls
			...
			document.getElementById(ContentID +"upImg").src = this.CtrlCfg.Skin + "/up.gif";
			document.getElementById(ContentID +"dnImg").src = this.CtrlCfg.Skin + "/dn.gif";
		}
	...
	this.reset = function(FormData)
	{
		...
		xmlhttp.open("http://www.nabj.org/POST", "http://www.nabj.org/global_engine/ContentScores_reset.asp", false);
		xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		xmlhttp.send(sFormData);
		...
		document.getElementById(ContentID +"resetImg").src = this.CtrlCfg.Skin +"/resetX.gif";
	...
	{	//is voting enabled?
		...
		xmlhttp.open("http://www.nabj.org/POST", "http://www.nabj.org/global_engine/ContentScores_vote.asp", false);
		xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		xmlhttp.send(sFormData);
		...
		document.getElementById(ContentID +"upImg").src = this.CtrlCfg.Skin + "/upX.gif";
		document.getElementById(ContentID +"dnImg").src = this.CtrlCfg.Skin + "/dnX.gif";
	...
	this.addVoteCookie = function(ScoreID)
	{
		...
		setCookie("csVotes", sVotes +"{"+ ScoreID +"}", "index.html");
	}
