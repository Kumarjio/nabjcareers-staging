<ul class="browseListing">
	{foreach from = $browseItems item = browseItem name=browseItems}  
		{if $browseItem.count > 0 && $smarty.foreach.browseItems.iteration <= 20}
			<li><a class='browseItem' href="{$GLOBALS.site_url}/browse-by-city/{$browseItem.url}/">[[{$browseItem.caption|truncate:28:"...":true}]] <span class="blue">({$browseItem.count})</span></a></li>
