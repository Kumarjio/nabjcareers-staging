			...
			<div class="compProfileInfo">
				{if $listing.anonymous != 1 || $applications.anonymous === 0 }
					...
					{if $listing.Resume.file_url != ""}
						<br /><img src="{image}view_ditail.png" alt=""/> <a href="?filename={$listing.Resume.saved_file_name}">[[Download Resume]]</a>
					{/if}	
	...
	<div id="listingsResults">
		...
		<div class="listingInfo">
			...
			<div class="clr"><br/></div>
				...
				<div class="smallListingInfo"><strong>[[FormFieldCaptions!Job Type]]:</strong> {display property=JobType}</div>
				<div class="smallListingInfo"><strong>[[FormFieldCaptions!Job Category]]:</strong> {display property=JobCategory}</div>
			<div class="clr"><br/></div>
