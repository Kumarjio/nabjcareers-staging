   ...
   {foreach from=$listings item=listing name=listings_block}
   	<item>
		...
		{if $listing_type_id == 'Resume'}
			<link>{$GLOBALS.site_url}/display-resume/{$listing.id}/{$listing.Title|regex_replace:"/[\\/\\\:*?\"<>|%#$\s]/":"-"}.html</link>
		...
		{else}
			<link><![CDATA[{$GLOBALS.site_url}/display-job/{$listing.id}/{$listing.Title|regex_replace:"/[\\/\\\:*?\"<>|%#$\s]/":"-"}.html]]></link>
			<description><![CDATA[{$listing.City}, [[$listing.State]]
