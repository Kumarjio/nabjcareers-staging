...
<form action="{$GLOBALS.site_url}/login/" method="post" id="loginForm" {if $ajaxRelocate} onsubmit="return loginSubmit()" {/if}>
	...
	<fieldset>
		...
		<div class="inputField"><input class="logInPassInput" type="password" name="password" /></div>
	</fieldset>
	<fieldset>
...
<br/>
<a  href="{$GLOBALS.site_url}/password-recovery/">[[Forgot Your Password?]]</a>&nbsp;|&nbsp; <a href="{$GLOBALS.site_url}/registration/">[[Registration]]</a>
