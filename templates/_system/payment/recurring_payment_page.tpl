<form id="formPayment" method="post" action="{$form_submit_url}">
	...
	<table>
		...
		<tr>
			<td colspan="2">[[Total]]: {$form_data_source.x_amount} {$form_data_source.x_currency_code}</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			<td>[[FormFieldCaptions!First Name]] <span style="color:#ff0000;">*</span>:</td>
			<td>
				<input type="text" class="input_text" id="x_first_name" name="x_first_name" maxLength="50" value="{$form_data_source.x_first_name}"/>
			</td>
		</tr>
		<tr>
			<td>[[FormFieldCaptions!Last Name]] <span style="color:#ff0000;">*</span>:</td>
			<td>
		...
		<tr>
			<td>[[FormFieldCaptions!Address]]:</td>
			<td>
