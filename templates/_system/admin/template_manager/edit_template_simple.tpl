...
{else}
	...
	<form action="{$GLOBALS.site_url}/edit-templates/" method="POST" id="form1" onsubmit="return saveTemplateSubmit();">
	
	<table width="20%">
		<tr>
		<td valign="top">	

		<p><a href="javascript:void(0)" onclick="insertStr()">Insert</a></p>		
		<table class="fieldset">
		    <!--tr><td><a href="javascript:void(0)" onclick="insertStr()">Insert</a></td></tr-->		
			<tr>
				<td>Module</td>
				<td>    	    
			...
			<tr><td valign=top colspan="2">Parameters:</td><td colspan="3"></td></tr>			
		</table>	 
	  ...
	  <tr>
		...
		<table style="width:100%">		
			<tr class="oddrow"><td> <textarea id="template_content" name="template_content" class="text" style="width:100%;height:300px">{$template_content|escape}</textarea></td></tr>
