...
<table>
	...
	{foreach from=$tree_items item=tree_value key=sid name=items_block}
		<tr class="{cycle values = 'evenrow,oddrow'}">
			<td>{$tree_value}</td>
			<td><a href="?field_sid={$field_sid}&amp;node_sid={$sid}&amp;user_group_sid={$user_group_sid}" title="Edit"><img src="{image}edit.png" border="0" alt="Edit"/></td>
			<td><a href="?field_sid={$field_sid}&amp;node_sid={$node_sid}&amp;action=delete&amp;item_sid={$sid}&amp;user_group_sid={$user_group_sid}" onclick="return confirm('Are you sure you want to delete this?')" title="Delete"><img src="{image}delete.png" border="0" alt="Delete"/></a></td>
			<td>
