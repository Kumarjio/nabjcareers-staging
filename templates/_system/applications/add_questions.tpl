...
<fieldset>
	...
	<div class="inputReq">&nbsp;</div>
	<div class="inputField">{if $action == 'edit'}<input type="submit" name="action_add" value="[[Save:raw]]" class="button" />{else}<input type="submit" name="action_add" value="[[Add:raw]]" class="button" />{/if}</div>
</fieldset>
</form>
{literal}
